...
function Section1() {
  return (
    <>
      <div className="py-[48px] sm:py-0 sm:min-h-[536px] bg-[#0A0A0A] flex items-center overflow-hidden">
        <div className="flex max-w-[1164px] mx-auto px-3 w-full sm:translate-y-[20px] flex-wrap ">
          <div className="w-full lg:w-1/2 pl-1 flex flex-col justify-center items-center lg:items-start text-center lg:text-start" data-aos="fade-right"
          data-aos-once="true">
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-start" data-aos="fade-left"
          data-aos-once="true">
