  ...
  return (
    <>
      <div className="bg-[#0A0A0A]">
        <div className="max-w-[1164px] mx-auto px-3 pb-[125px]">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <div className="group max-w-[369px] min-h-[289px] rounded-[16px] border border-solid border-[rgba(255, 255, 255, 0.20)] bg-[#353535] pt-[25px] pl-[20px] pr-[19px] hover:bg-[#FDDA60] hover:shadow-[0px_14px_56px_0px_rgba(253,218,96,0.50)] flex flex-col items-center relative overflow-hidden">
              ...
              <h3 className="py-4 text-white group-hover:text-black text-center font-montserrat text-2xl not-italic font-semibold group-hover:font-bold leading-[108.744%]">
                Document
              </h3>
              <p className="text-white group-hover:text-black text-center font-montserrat text-base not-italic font-normal leading-[160%]">
            ...
            <div className="group max-w-[369px] min-h-[289px] rounded-[16px] border border-solid border-[rgba(255, 255, 255, 0.20)] bg-[#353535] pt-[25px] pl-[20px] pr-[19px] hover:bg-[#FDDA60] hover:shadow-[0px_14px_56px_0px_rgba(253,218,96,0.50)] flex flex-col items-center relative overflow-hidden">
              ...
              <h3 className="pt-[19px] pb-[14px] text-white group-hover:text-black text-center font-montserrat text-2xl not-italic font-semibold group-hover:font-bold leading-[108.744%]">
                Deal
              </h3>
              <p className="text-white group-hover:text-black text-center font-montserrat text-base not-italic font-normal leading-[160%]">
                Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae
